...
import (
	...
	"bluebell_microservices/comment-service/internal/controller"
...
func main() {
	...
	// 初始化日志
	if err := logger.Init("info", "comment-service.log"); err != nil {
	...
	logger.Info("Comment service running", zap.String("addr", ":8083"))
